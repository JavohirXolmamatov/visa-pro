...
export default function Header() {
  ...
  // Scroll bo‘lganda navbar fonini o‘zgartirish
  // useEffect(() => {
  //   const handleScroll = () => {
  ...
  return (
    ...
    >
      <nav className="w-9/10 mx-auto h-full scroll-smooth flex items-center justify-between">
        {/* Logo */}
        <img src={logo} alt="icon" className="h-12 w-12" />
        {/* Desktop Menu */}
        <ul className="hidden md:flex gap-6 uppercase font-bold text-sm scroll-smooth">
          <li>
            <a href="#about" className="hover:text-red-500 scroll-smooth">
              {t("header.about")}
            </a>
          </li>
          <li>
            <a href="#countries" className="hover:text-red-500">
              {t("header.country")}
            </a>
          </li>
          <li>
            <a href="#works" className="hover:text-red-500">
              {t("header.work")}
            </a>
          </li>
          <li>
